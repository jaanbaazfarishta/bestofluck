...
export default function Add() {
    ...
    return (
        <div className='sm:hidden flex flex-col ju items-center p-4 gap-4'>
            <div>
                <p className='text-justify'>First make payment on of the following UPI IDs then fill the Form.</p>
                <p className='text-justify'>It can take upto 5 to 60 minutes to reflect data in your Game account</p>
            </div>
            <div>
                <form onSubmit={handleSubmit} className="text-black">
                    <h1 className="text-white text-2xl underline">Add Balance</h1>
